...
To see the whole report generated by the Aqua scanner, including detected *malware* and *sensitive data*, you have to navigate from Harbor Portal to Aqua Management Console.

Similarly, Harbor does not have support for displaying or enforcing Aqua's *image assurance policies*. You will need to use the Aqua Management Console to view and configure these policies.
