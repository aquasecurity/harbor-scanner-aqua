...
| `scanner.aqua.scannerCLIOverrideRegistryCredentials` | The flag to enable passing `--registry-username` and `--registry-password` flags to the `scannercli` executable binary | `false` |
